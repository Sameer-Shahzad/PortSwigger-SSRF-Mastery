...
1. Intercepting the initial backend stock status endpoint request
![Responses](../images/Lab1/solved.png)

2. Setting up the Intruder position parameter payload configuration to target the IP range
![Responses](../images/Lab1/solved.png)

3. Inspecting the active subnet responses to locate the operational host (IP: `192.168.0.23`)
![Responses](../images/Lab1/solved.png)

4. Forwarding the final user deletion endpoint payload string inside Burp Repeater
![Responses](../images/Lab1/solved.png)
